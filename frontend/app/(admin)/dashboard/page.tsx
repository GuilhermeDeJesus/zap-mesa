...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-6xl space-y-6">
      <section className="rounded-3xl bg-slate-900 text-white p-6 md:p-8 shadow-[0_24px_60px_rgba(15,23,42,0.12)] overflow-hidden relative">
        ...
        <div className="relative flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-xs uppercase tracking-[0.22em] text-orange-200/70 mb-2">Operação do restaurante</p>
          ...
          <div className="rounded-2xl bg-white/10 border border-white/10 px-4 py-3 backdrop-blur-sm">
            ...
            <code className="text-sm text-orange-100 break-all">{menuUrl || "..."}</code>
          </div>
        </div>
      </section>
      ...
      <div className="bg-white/90 backdrop-blur rounded-3xl border border-white/70 p-5 md:p-6 shadow-sm">
        <p className="text-sm font-semibold text-slate-700 mb-2">Link do cardápio público</p>
